...
def _get_ood_transform_dict(dataset_name: str) -> dict[str, Callable]:
    if "cifar" in dataset_name:
        module = import_module("untangle.transforms.ood_transforms_cifar")

        return module.OOD_TRANSFORM_DICT_CIFAR

    module = import_module("untangle.transforms.ood_transforms_imagenet")

    return module.OOD_TRANSFORM_DICT_IMAGENET
...
class OODTransform:
    ...
    def __init__(
        ...
        transform_dict = _get_ood_transform_dict(dataset_name)
...
def create_transform(
    ...
    Raises:
        ValueError: If OOD transformations are applied during training.
    """
