...
def float_tuple(string: str) -> tuple[float, ...]:
    ...
    Returns:
        A tuple of floats corresponding to the input string.
    """
    if not string:
        return ()
...
def int_tuple(string: str) -> tuple[int, ...]:
    ...
    Returns:
        A tuple of integers corresponding to the input string.
    """
    if not string:
        return ()
...
def path_tuple(string: str) -> tuple[Path, ...]:
    ...
    Returns:
        A tuple of Path objects corresponding to the input string.
    """
    if not string:
        return ()
...
def module(string: str) -> nn.Module:
    ...
    Raises:
      ValueError: If string does not start with "nn."
    """
...
group.add_argument(
    "--include-params-regex",
    type=str,
    default=None,
    help="Which parameters to include in Laplace",
)
group.add_argument(
    "--epistemic-params-regex",
    type=str,
    default=None,
    help="Which parameters to include in epistemic Laplace",
)
group.add_argument(
    "--aleatoric-params-regex",
    type=str,
    default=None,
    help="Which parameters to include in aleatoric Laplace",
)
group.add_argument(
    "--rank",
    type=int,
    default=30,
    help="Rank of the low-rank approximation in the Laplace method",
)
group.add_argument(
    "--approx-method",
    type=str,
    default="kfac",
    help="Method for approximating the Hessian in the Laplace method",
)
...
def parse_args() -> argparse.Namespace:
    ...
    Returns:
        Parsed and processed command-line arguments as a Namespace object.
    """
...
def resolve_data_config(args: dict[str, Any]) -> dict[str, Any]:
    ...
    Returns:
        A dictionary containing resolved data configuration.
    """
    data_config = {}
