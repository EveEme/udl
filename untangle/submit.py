...
parser.add_argument(
    "--username",
    type=str,
    default="evelyn-emelanov",
    help="The Weights & Biases username",
)
parser.add_argument(
    "--project", type=str, default="thesis", help="The Weights & Biases project"
)
parser.add_argument(
...
parser.add_argument(
    "--simg-path",
    type=Path,
    default=Path("/home/hennig/hmx965/untangle/untangle.simg"),
    help="Path to Singularity image",
)
parser.add_argument(
    "--repo-path",
    type=Path,
    default=Path("/home/hennig/hmx965/bul"),
    help="Path to repository",
)
parser.add_argument(
    "--datasets-root-path",
    type=Path,
    default=Path("/home/hennig/hmx965/bul/untangle/datasets"),
...
parser.add_argument(
    "--log-path",
    type=Path,
    default=Path("/home/hennig/hmx965/logs"),
...
class SlurmJob:
    ...
    def _check_job_name(job_name: str) -> None:
        ...
        Raises:
            ValueError: If the job name does not match the required format.
        """
    ...
    def _check_memory_format(mem: str) -> None:
        ...
        Raises:
            ValueError: If `mem` does not match the required format.
        """
    ...
    def _check_time_format(time: str) -> None:
        ...
        Raises:
            ValueError: If `time` does not match the required format.
        """
